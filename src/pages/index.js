...
import waveVideo from "../images/waves.webm"
    ...
    <div className="contained" style={{
      ...
      <section id="hi"  >
        ...
        <div style={{ position: "relative" }} >
          ...
          <video muted autoPlay loop src={waveVideo} type="video/webm" />
          ...
          <div className="hero-group-text">
            ...
            <p className="hero-description">Seattle based Software Engineer, experienced in web and mobile development</p>
