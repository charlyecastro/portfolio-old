...
const Limeade = ({ data }) => (
  ...
  <Layout>
    ...
    <Overview
      paragraph={["For this class project we decided to build a multiplayer web app game based on ", <a href="https://www.zynga.com/games/words-with-friends-2/">Words with Friends </a>, ". Our web app is called ", <a href="https://info343d-a17.github.io/group-ifigon/words_with_friends/build/#/">Wordz with Friendz </a>, " (really unique, i know). For those who don't know the game words with friends. You are essentially assigned random letters and you need to spell out words with them. Each letter has a certain amount of points and the objective is to spell words that tally up more points than your opponent. The challenge of building this game was the word verification, we had to figure out how to check words horizontally and vertically."]}
      par2={["To handle this, the data structure we used was a 2d array, this helps imitate X and Y coordinates. This makes it possible to associate letters with letters that are left and right of each other or above and below. In order to confirm that the word being submitted we used the ", <a href="https://developer.oxforddictionaries.com/">Oxford Dictionary API</a>, " for verification. My job was to work on the random letter tile generator, which assigned letters and their points to users when they first start the game or need a new set of letters. To build this application we used ", <a href="https://reactjs.org/">React</a>, " and ", <a href="https://firebase.google.com/">Firebase</a>, " for user authentication. There was a lot of communication in the team and we tackled issues together. It was a little intimidating in the beginning, however working through our problems with a committed team, the project ended up being a fun learning experience."]}
